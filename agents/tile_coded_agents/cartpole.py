...
from agent_utils import save_linear_agent, load_linear_agent, test_linear_agent, compare_agents, plot_rewards
...
save_linear_agent(standard_agent, "standard_agent")
save_linear_agent(tile_agent, "tile_agent")
loaded_s_agent = load_linear_agent("standard_agent")
loaded_t_agent = load_linear_agent("tile_agent")


test_linear_agent(standard_agent)
test_linear_agent(loaded_s_agent)
test_linear_agent(tile_agent)
test_linear_agent(loaded_t_agent)
