...
class SimpleDoubleSarsa(Base_Double_Sarsa_Agent):
    """
    Double Sarsa Agent that has no eligibility traces or experience replay.
    """
    ...
    def train(self, num_episodes=5000, bot_difficulty=0, render_mode=None):
        """
        Trains the agent using a double sarsa approach with no experience replay
        """
