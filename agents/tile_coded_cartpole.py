...
if __name__ == "__main__":
    ...
    # Save agents
    save_agent(standard_agent_no_PER, "standard_agent_no_PER")
    save_agent(standard_agent_PER, "standard_agent_PER")
    save_agent(tile_agent_no_PER, "tile_agent_no_PER")
    save_agent(tile_agent_PER, "tile_agent_PER")

    # Test agents
    test_agent(standard_agent_no_PER, cartpole=True)
    test_agent(standard_agent_PER, cartpole=True)
    test_agent(tile_agent_no_PER, cartpole=True)
    test_agent(tile_agent_PER, cartpole=True)
