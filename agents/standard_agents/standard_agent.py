...
import random
from utils.agent_utils import load_linear_agent, save_linear_agent, plot_rewards, test_linear_agent
...
save_linear_agent(agent, "standard_reduced")
loaded_agent = load_linear_agent("standard_reduced")
test_linear_agent(loaded_agent)
